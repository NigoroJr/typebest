...
public class ColorSelector extends JDialog {
    ...
    /**
     * Shows a new color selection dialog with the current (default values)
     * being black.
     */
    ...
    /**
     * Creates a new color selection dialog with the default values of the given
     * color.
     * There are 2 preview windows, one being the current color and the other
     * being the color
     * from the current value of the sliders. 3 sliders each represents the
     * value of red, green, blue
     * respectively and the right preview window will update itself as the user
     * slides the slider.
     * 
     * @param current
     *            The color that will be set as the default value.
     */
    public ColorSelector(final Color current) {
                ...
                this.add(new JPanel() {
                    {
                        this.setBackground(new
                                Color(redSlider.getValue(), greenSlider
        ...
        ChangeListener slide = new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                preview.getComponent(1).setBackground(
                        new Color(redSlider.getValue(), greenSlider.getValue(),
                                blueSlider.getValue()));
            }
        };
